...
MyDesktop = new Ext.app.App({
    ...
    getModules : function(){
        return [
        // GROUPS WINDOWS
        new MyDesktop.GroupManagerWindow(),
        new MyDesktop.SimpleGroupFormWindow(),
        new MyDesktop.ComplexGroupFormWindow(),
            
        // USERS WINDOWS
        new MyDesktop.UserManagerWindow(),
        new MyDesktop.UserFormWindow(),


        // GROUPS_USERS WINDOWS
        new MyDesktop.GroupsUserFormWindow(),

        // SERVICES WINDOWS
        new MyDesktop.ServicesManagerWindow(),
        new MyDesktop.ServiceFormWindow(),

        // LAYERS WINDOWS
        new MyDesktop.SimpleLayersFormWindow(),
