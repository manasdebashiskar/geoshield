...
Ext.grid.SmartCheckboxSelectionModel = Ext.extend(Ext.grid.RowSelectionModel, {
    ...
    initEvents : function(){
        ...
        */
        ...
        this.addEvents("SmartRowClick","evToggleChecked","beforeToggleChecked");
    ...
    toggleChecked : function(rowIndex, c){
        var cont = this.fireEvent("beforeToggleChecked",rowIndex, c);
        if(cont===true || cont == undefined){
            ...
            this.fireEvent("evToggleChecked",rowIndex, c);
        }
    },
    ...
    handleMouseDown : function(g, rowIndex, e){
        ...
        this.fireEvent("SmartRowClick",g, rowIndex, e);
    },
    /**
